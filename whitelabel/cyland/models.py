...
class WhitelabelCylandFactory(object):
    def __init__(self):
        pass

    @staticmethod
    def create(user):
        path = 'https://s3-us-west-2.amazonaws.com/ascribe0/whitelabel/cyland/'
        logo = path + 'logo.gif'
        ...
        market.acl_update_public_contract = True
        ...
        market.acl_view_settings_account_hash = True
        market.acl_view_settings_api = True
        market.acl_view_settings_bitcoin = True
